...
public class BitmapEncoder {
    static final int HEADER_SIZE = Long.SIZE / Byte.SIZE + 4;

    private static byte[] createHeader(long size) {
    ...
    static Bitmap encode(Bitmap inBitmap, byte[] bytes) {
    ...
    static byte[] decode(Bitmap inBitmap) {
