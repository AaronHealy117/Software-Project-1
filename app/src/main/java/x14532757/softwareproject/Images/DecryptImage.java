...
public class DecryptImage extends Activity {
    ...
    private final String TAG = "decryptImage";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        storageReference = storage.getReferenceFromUrl("gs://softwareproject-b1a79.appspot.com/Images").child(userID).child(imagename);
        //database ref
            ...
            public void onClick(View v) {
                ...
                if(success.equals(successMessage)){
                    ...
                    if(!Objects.equals(pincode, pinc)){
                        Toast.makeText(DecryptImage.this, "Pin Incorrect", Toast.LENGTH_SHORT).show();
                    }
                    if(pincode.isEmpty()){
                        Toast.makeText(DecryptImage.this, "Pin Empty", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        decrypt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final File localFile = new File(rootPath, image);

                storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                    @Override
                    public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                        Toast.makeText(DecryptImage.this, "Download Complete", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(DecryptImage.this, "Download Failed", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
                    }
    ...
    private void DeleteData() {
        ...
        storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(DecryptImage.this, "Image Deleted", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(DecryptImage.this, "Image Deletion Failure", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.getChildrenCount() > 0){
                    for(DataSnapshot itemSnapshot : dataSnapshot.getChildren()){
                        ...
                        Toast.makeText(DecryptImage.this, "Data Deleted", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(DecryptImage.this, ViewImage.class);
                        startActivity(intent);
                    }
                }else{
                    Toast.makeText(DecryptImage.this, "Failed to delete", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(DecryptImage.this, "Error occurred", Toast.LENGTH_SHORT).show();
            }
        });
    }
